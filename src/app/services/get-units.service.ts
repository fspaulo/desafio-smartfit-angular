...
export class GetUnitsService {
  ...
  private allUnitsSubject: BehaviorSubject<Location[]> = new BehaviorSubject<Location[]>([]); // BehaviorSubject funciona como um watch
  private allUnits$: Observable<Location[]> = this.allUnitsSubject.asObservable(); // observado pelos outros
